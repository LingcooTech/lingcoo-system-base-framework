...
CREATE UNIQUE INDEX "storage_assets_connection_object_idx"
  ON "storage_assets" ("connection_id", "object_key");
CREATE INDEX "storage_assets_status_created_idx"
  ON "storage_assets" ("status", "created_at" DESC);
CREATE INDEX "storage_assets_kind_created_idx"
...
CREATE UNIQUE INDEX "storage_asset_references_owner_field_idx"
  ON "storage_asset_references" ("owner_type", "owner_id", "field");
CREATE INDEX "storage_asset_references_asset_idx"
